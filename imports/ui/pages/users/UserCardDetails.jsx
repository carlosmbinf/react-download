    ...
    PreciosCollection.find(
      ...
      .map((a) => {
        precioslist.push({
          ...
          label: `${a.type} • ${a.megas}MB • $ ${a.precio >= 0
              ? a.precio
              : 0
            }`,
        });
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            {`Usted desea eliminar el usuario ${users && users.profile && users.profile.firstName
                                        ...
                                        label={
                                          users.isIlimitado
                                            ? ` ${PreciosCollection.findOne({
                                              ...
                                              ? `Limitado por Fecha ($${PreciosCollection.findOne({
                                                type: "fecha-proxy",
                                              }).precio -
