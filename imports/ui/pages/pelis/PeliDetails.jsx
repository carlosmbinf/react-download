...
export default function PeliDetails() {
  ...
  const handleChange = (event) => {
    PelisCollection.update(peliDetails._id, {
      $set: { mostrar: !(peliDetails.mostrar == "true") },
    });
  };
                ...
                >
                  <Grid style={{ width: "100%" }}>
                    ...
                    <video
                      ...
                      poster={peliDetails.urlBackground}
                      preload="metadata"
                    >
                      <source
                        src={peliDetails.urlPeli}
