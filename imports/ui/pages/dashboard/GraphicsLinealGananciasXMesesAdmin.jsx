...
export default function GraphicsLinealGananciasXMesesAdmin() {
  ...
  const aporte = (fechaStart, fechaEnd) => {
    ...
    ventas.map(element => {
      ...
      if (id) {
        ...
        fechaElement >= fechaInicial && fechaElement < fechaFinal && (totalAPagar += element.gananciasAdmin?element.gananciasAdmin:0)
      }
